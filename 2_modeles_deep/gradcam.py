...
def display_headmap(preprocess_function, img_path, img_size, model, last_conv_layer_name, pred_index=None):
    img = plt.imread(img_path)
    img_array = preprocess_function(get_img_array(img_path, size=img_size))
